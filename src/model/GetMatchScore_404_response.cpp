...
GetMatchScore_404_response::CodeEnum GetMatchScore_404_response::toCodeEnum(const utility::string_t& value) const
{
    ...
    if (value == utility::conversions::to_string_t("ScoreNotFound")) {
        return CodeEnum::SCORENOTFOUND;
    }
...
const utility::string_t GetMatchScore_404_response::fromCodeEnum(const CodeEnum value) const
{
    switch(value)
    {
        ...
        case CodeEnum::SCORENOTFOUND: return utility::conversions::to_string_t("ScoreNotFound");
        
    }
}


GetMatchScore_404_response::CodeEnum GetMatchScore_404_response::getCode() const
{
    return m_Code;
}


void GetMatchScore_404_response::setCode(const CodeEnum value)
{
    m_Code = value;
    m_CodeIsSet = true;
}
