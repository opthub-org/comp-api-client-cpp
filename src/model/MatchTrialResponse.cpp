...
web::json::value MatchTrialResponse::toJson() const
{
    ...
    if(m_TrialNoIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("trialNo"))] = ModelBase::toJson(m_TrialNo);
    }
    if(m_StatusIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("trialNo"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("trialNo")));
...
void MatchTrialResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_TrialNoIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("trialNo")), m_TrialNo));
    }
    if(m_StatusIsSet)
    {
...
bool MatchTrialResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("trialNo"))))
    {
        int32_t refVal_setTrialNo;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("trialNo"))), refVal_setTrialNo );
        setTrialNo(refVal_setTrialNo);
    }
